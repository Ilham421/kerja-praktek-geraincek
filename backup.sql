...
--
DROP DATABASE IF EXISTS `kerja_praktek`;
CREATE DATABASE `kerja_praktek` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci;
USE `kerja_praktek`;
...
-- (DIBUAT DULUAN karena tabel lain referensi ke users)
--
...
(1, 'ilham', '$2b$10$0rHHFvd4dljin4I.WOxlB.F/svnL.TnGuCT.pmSDkcifzk1jNh292', 'superadmin', '2026-06-04 18:00:00');
...
--
-- Triggers untuk service_tickets
--
