    ...
    <>
      ...
      <section className="mx-auto max-w-7xl px-6 py-24 lg:px-8">
        <div className="grid gap-12 md:grid-cols-2 md:items-center">
          <div className="space-y-8">
            <div>
              <div className="inline-flex rounded-full bg-blue-100 px-4 py-2 text-sm font-semibold text-blue-600 mb-4">
                ⚡ Solusi Service Terpercaya
              </div>
            ...
            <p className="text-xl text-gray-600 leading-relaxed max-w-lg">
              Gerai Ncek menyediakan layanan reparasi berkualitas tinggi dengan teknisi berpengalaman, garansi resmi, dan harga transparan.
            </p>
            ...
            <div className="grid gap-4 sm:grid-cols-2 text-sm text-gray-600">
              <div className="flex gap-2"><span>✓</span> <span>Garansi Resmi</span></div>
              <div className="flex gap-2"><span>✓</span> <span>Teknisi Berpengalaman</span></div>
              <div className="flex gap-2"><span>✓</span> <span>Harga Transparan</span></div>
              <div className="flex gap-2"><span>✓</span> <span>Konsultasi Gratis</span></div>
            </div>
          </div>
          ...
          <div className="relative">
            <div className="rounded-3xl bg-gradient-to-br from-blue-100 to-blue-50 p-8 shadow-2xl">
              <div className="rounded-2xl bg-white p-8 shadow-lg space-y-6">
                <h3 className="text-2xl font-bold text-gray-900">Kenapa Pilih Kami?</h3>
                <div className="space-y-4">
                  {[
                    { n: 1, t: "Eksper 2+ Tahun", d: "Ratusan perangkat sukses diperbaiki" },
                    { n: 2, t: "Suku Cadang Ori", d: "Kualitas terjamin untuk jangka panjang" },
                    { n: 3, t: "Proses Cepat", d: "Banyak servis selesai di hari yang sama" }
                  ].map((item) => (
      ...
      <section id="layanan" className="bg-gray-50 py-12 md:py-20">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="mb-10 md:mb-16 space-y-4 text-center">
            <p className="text-sm font-semibold uppercase tracking-widest text-blue-600">Layanan Kami</p>
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900">Solusi Lengkap Perangkat Anda</h2>
          </div>
          <div className="grid gap-6 grid-cols-1 sm:grid-cols-2 lg:grid-cols-4">
            {services.map((service) => (
              <div key={service.title} className="rounded-2xl border-2 border-gray-100 bg-white p-8 text-center transition hover:-translate-y-2 hover:border-blue-300 hover:shadow-lg">
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <div className="grid gap-12 lg:grid-cols-2 lg:items-center">
            <div className="space-y-6">
              <h2 className="text-4xl font-bold text-gray-900">Reputasi Terpercaya Sejak 2023</h2>
              <p className="text-lg text-gray-600 leading-relaxed">
                Berawal dari jasa private hingga kini menjadi Gerai Ncek, kami berkomitmen memberikan hasil terbaik untuk menjaga kepercayaan pelanggan baru maupun lama.
              </p>
            </div>
      ...
      <section id="status" className="bg-gradient-to-br from-blue-50 to-white py-20">
        <div className="mx-auto max-w-7xl px-6 lg:px-8 text-center">
          ...
          <p className="text-gray-600 mb-12">Masukkan nomor nota Anda untuk mengecek progres perbaikan.</p>
      ...
      <section id="kontak" className="py-20 bg-white">
        ...
        <div className="mt-20 max-w-2xl mx-auto px-6">
          <h2 className="text-3xl font-bold text-center mb-8">Kirim Pesan Langsung</h2>
          <ContactForm />
        </div>
      </section>
    </>
