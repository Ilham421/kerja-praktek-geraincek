...
import { Wrench, LayoutDashboard, ExternalLink, Search } from "lucide-react";
  ...
  const [services, setServices] = useState([
    {
      ...
      issue: "Ganti LCD iPhone 11",
      status: "Sedang Diproses",
    },
    {
      id: "NC-002",
      customer: "Siti Aminah",
      issue: "Laptop Mati Total",
    ...
    <div className="min-h-screen bg-gray-100 flex">
      ...
      <aside className="w-64 bg-blue-900 text-white p-6 hidden md:block">
        ...
        <nav className="space-y-4">
          <div className="p-3 bg-blue-800 rounded-lg cursor-pointer flex items-center gap-2">
            <LayoutDashboard className="w-4 h-4" /> Dashboard Servis
          </div>
          <Link
            href="/"
            className="block p-3 hover:bg-blue-800 rounded-lg transition flex items-center gap-2"
          >
      ...
      <main className="flex-1 p-8">
        <header className="mb-8 flex justify-between items-center">
          <h2 className="text-3xl font-bold text-gray-800 flex items-center gap-2">
            <Wrench className="w-7 h-7" /> Dashboard Input Servis
          </h2>
